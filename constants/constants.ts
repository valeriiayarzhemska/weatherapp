...
export const weatherImages = {
  ...
  'light intensity shower rain': require(`../assets/images/heavy_intensity_rain${timeCheck ? '_night' : ''}.png`),
  'shower rain': require(`../assets/images/heavy_intensity_rain${timeCheck ? '_night' : ''}.png`),
  'heavy intensity shower rain': require(`../assets/images/heavy_intensity_rain${timeCheck ? '_night' : ''}.png`),
  'ragged shower rain': require(`../assets/images/heavy_intensity_rain${timeCheck ? '_night' : ''}.png`),
  'light snow': require('../assets/images/snow.png'),
  'snow': require('../assets/images/snow.png'),
  'heavy snow': require(`../assets/images/heavy_snow${timeCheck ? '_night' : ''}.png`),
  'sleet': require(`../assets/images/heavy_snow${timeCheck ? '_night' : ''}.png`),
  'light shower sleet': require(`../assets/images/heavy_snow${timeCheck ? '_night' : ''}.png`),
  'shower sleet': require(`../assets/images/heavy_snow${timeCheck ? '_night' : ''}.png`),
  'light rain and snow': require(`../assets/images/heavy_snow${timeCheck ? '_night' : ''}.png`),
  'rain and snow': require(`../assets/images/heavy_snow${timeCheck ? '_night' : ''}.png`),
  'light shower snow': require(`../assets/images/heavy_snow${timeCheck ? '_night' : ''}.png`),
  'shower snow': require(`../assets/images/heavy_snow${timeCheck ? '_night' : ''}.png`),
  'heavy shower snow': require(`../assets/images/heavy_snow${timeCheck ? '_night' : ''}.png`),
  ...
  'clear sky': require(`../assets/images/clear_sky${timeCheck ? '_night' : ''}.png`),
  'few clouds': require(`../assets/images/few_clouds${timeCheck ? '_night' : ''}.png`),
  ...
  'else': require(`../assets/images/few_clouds${timeCheck ? '_night' : ''}.png`),
}
